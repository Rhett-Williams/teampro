...
function DisplayUsers(props) {
  ...
  if (uid !== auth.currentUser.uid) {
    return (
      ...
      <img src="https://img.icons8.com/external-kiranshastry-lineal-kiranshastry/64/000000/external-user-interface-kiranshastry-lineal-kiranshastry.png" style={{ height: "50px"}}/>
